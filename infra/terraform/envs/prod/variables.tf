...
variable "discover_lambda_arn" {
  ...
  type        = string
  default     = "arn:aws:lambda:us-east-1:000000000000:function:etl-agent-prod-discover"
}

variable "translate_lambda_arn" {
  description = "ARN of the Translate Lambda function"
  type        = string
  default     = "arn:aws:lambda:us-east-1:000000000000:function:etl-agent-prod-translate"
}

variable "deploy_lambda_arn" {
  description = "ARN of the Deploy Lambda function"
  type        = string
  default     = "arn:aws:lambda:us-east-1:000000000000:function:etl-agent-prod-deploy"
}

variable "verify_lambda_arn" {
  description = "ARN of the Verify Lambda function"
  type        = string
  default     = "arn:aws:lambda:us-east-1:000000000000:function:etl-agent-prod-verify"
}
